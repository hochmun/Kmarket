 ...
 <main id="product">
            <aside>
                <ul class="category">
                    ...
                    <li>
                        <a href="/Kmarket/product/list.do?cate1=11"><i class="fas fa-tshirt"></i>패션·의류·뷰티</a>
                        <ol>
                    ...
                    <li>
                        <a href="/Kmarket/product/list.do?cate1=13"><i class="fas fa-utensils"></i>식품·생필품</a>
                        <ol>
                    ...
                    <li>
                        ...
                        <ol>
                            ...
                            <li><a href="/Kmarket/product/list.do?pg=${pg}&cate1=14&cate2=16">잡화</a></li>
                            <li><a href="/Kmarket/product/list.do?pg=${pg}&cate1=14&cate2=13">뷰티</a></li>
                        </ol>
                    </li>
                </ul>
            </aside>
            ...
            <section class="list">
                ...
                <c:forEach var="product" items="${pvos}">
	                <tr>
	                    <td><a href="/Kmarket/product/view.do?prodNo=${product.prodNo}" class="thumb"><img src="https://via.placeholder.com/120x120" alt="상품이미지"></a></td>
	                    <td>
	                    ...
	                    <td>
                            ...
                            <c:when test="${product.delivery eq 0}">
	                            ...
	                            <c:otherwise>
	                            <li><span>${product.delivery}</span></li>
	                            </c:otherwise>
	                            </c:choose>
	                        </ul>
	                    </td>
